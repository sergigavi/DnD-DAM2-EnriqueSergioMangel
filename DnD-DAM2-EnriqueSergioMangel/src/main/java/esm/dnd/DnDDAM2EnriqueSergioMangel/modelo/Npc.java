...
public class Npc {
    ...
    public Npc(Npc npc){
        this.idNpc=ObjectId.get();
        this.nivel=npc.nivel;
        this.nombre=npc.nombre;
        this.bonifCompetencia=calcBonifCompetencia(this.nivel);
        this.caracteristicas=npc.getCaracteristicas();
        this.habilidades=setHabilidades(caracteristicas, habilidades, this.bonifCompetencia);
        this.rasgos=npc.rasgos;
        this.alineamiento=npc.alineamiento;
        this.puntosVidaMax=npc.puntosVidaMax;
        this.ca=npc.ca;
        this.desafio=npc.desafio;
        this.velocidad=npc.velocidad;
        this.raza=npc.raza;
        this.clase=npc.clase;
    }
